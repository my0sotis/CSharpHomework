...
namespace Order
{
    public class Order
    {
        public Order(string num, string name, uint cate)
        {
            OrderId = num;
            ClientName = name;
    ...
    public class OrderService
    {
        ...
        public List<Order> SearchByOrderNum()
        {
            return ListOfOrder;
        }
        ...
        public List<Order> SearchByClientName()
        {
            return ListOfOrder;
        }
        ...
        public List<Order> SearchByProductName()
        {
            return ListOfOrder;
        }
        ...
        public List<Order> SearchByPriceOfProduct()
        {
            return ListOfOrder;
        }
        ...
        public List<Order> SearchByNumOfProduct()
        {
            return ListOfOrder;
        }
        ...
        public List<Order> SearchByWhichTotalPriceOver()
        {
            return ListOfOrder;
        }
