...
namespace Program
{
    ...
    public partial class AddOrderForm : Form
    {
        ...
        public AddOrderForm(List<Order.Order> list)
        {
            InitializeComponent();
            this.orders = list;
        }
        ...
        private bool CheckOrderIdValid(TextBox textBox)
        {
            ...
            {
                MessageBox.Show("你所输入的订单号不符合规范，应为“年月日+三位流水号”的形式。", "输入错误！", MessageBoxButtons.OK, MessageBoxIcon.Information);
                textBox.Text = null;
                return false;
            }
        }
        ...
        {
            foreach (Order.Order o in orders)
                if (o.OrderId == textBox.Text)
                {
                    MessageBox.Show("你所输入的订单号有重复！", "输入错误!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    textBox.Text = null;
                    return false;
                }
            return true;
        ...
        private bool CheckPhoneNumber(TextBox textBox)
        {
            ...
            {
                MessageBox.Show("你所输入的客户手机号码格式有误。", "输入错误！", MessageBoxButtons.OK, MessageBoxIcon.Information);
                textBox.Text = null;
                return false;
            }
        }
